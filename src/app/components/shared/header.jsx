...
function Header({ userType }) {
  ...
  const iconStyle = { marginRight: "5px", color: "white" };
  ...
  return (
    <>
      {token && userType === ROLES.ADMIN ? (
        ...
        <>
          <header id="masthead" className={`site-header header-primary ${token && userType === ROLES.ADMIN ? "force-display-none" : ""}`}>
              ...
              <div className="container-fluid px-lg-3 d-flex align-items-center buttom-header-container">
                <div className="site-identity">
                  <h1 className="site-title">
                    <Link href="/">
                      <Image src={logo2} priority alt="logo" width={200} height={200} />
                    </Link>
                  </h1>
                </div>
                ...
                <div className="header-btn">
                  ...
                  {!token ? (
                    <Link href="/login" className="button-primary login-btn">
                      SIGN IN
                    </Link>
                  ) : (
                    <button onClick={handleLogout} className="button-primary logout-btn">
                      SIGN OUT
                    </button>
                  )}
                </div>
            ...
            <div className="mobile-menu-container">
              <div className="slicknav_menu">
                <button className="slicknav_btn mobile-menu-toggle" onClick={toggleMobileMenu}>
                  <span className="slicknav_menutxt">Menu</span>
                  <span className="slicknav_icon">
                    <FaBars style={iconStyle} />
                  </span>
                </button>
                <nav className={`slicknav_nav d-lg-none ${isMobileMenuOpen ? 'd-block' : 'd-none'}`}>
